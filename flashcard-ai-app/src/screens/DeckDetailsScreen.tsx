...
type DeckDetailsScreenNavigationProp = StackNavigationProp<RootStackParamList, 'DeckDetails'>;
type DeckDetailsScreenRouteProp = RouteProp<RootStackParamList, 'DeckDetails'>;
  ...
  const loadDeckData = async () => {
    try {
      const [deckData, cards] = await Promise.all([
        databaseService.getDeck(deckId),
        databaseService.getFlashcards(deckId),
      ]);
