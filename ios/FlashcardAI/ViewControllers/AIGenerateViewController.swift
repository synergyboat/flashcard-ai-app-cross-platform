...
class AIGenerateViewController: UIViewController {
    ...
    private let cardCountTextField: UITextField = {
        ...
        textField.text = "\(AppConfig.CardLimits.defaultValue)"
    ...
    @objc private func generateButtonTapped() {
        ...
        guard let cardCountText = cardCountTextField.text,
              ...
              cardCount >= AppConfig.CardLimits.min && cardCount <= AppConfig.CardLimits.max else {
        ...
        Task {
            do {
                ...
                // Create flashcards - IDs will be auto-generated by database
    ...
    private func resetForm() {
        topicTextView.text = ""
        cardCountTextField.text = "\(AppConfig.CardLimits.defaultValue)"
