...
void configDomainDi() {
  ...
  getIt.registerSingleton<UpdateFlashcardUseCase>(UpdateFlashcardUseCase(getIt<FlashcardRepository>()));
  getIt.registerSingleton<UpdateDeckUseCase>(UpdateDeckUseCase(getIt<DeckRepository>()));
}